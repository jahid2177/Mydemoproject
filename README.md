...
# 📊 Project Stats
[![GitHub forks](https://img.shields.io/github/forks/jahid2177/LiveTVCollector?logo=forks&style=plastic)](https://github.com/jahid2177/LiveTVCollector/network) [![GitHub stars](https://img.shields.io/github/stars/jahid2177/LiveTVCollector)](https://github.com/jahid2177/LiveTVCollector/stargazers) [![made-with-python](https://img.shields.io/badge/Made%20with-Python-1f425f.svg)](https://www.python.org/)  [![MIT license](https://img.shields.io/badge/License-MIT-blue.svg)](https://lbesson.mit-license.org/)
![GitHub issues](https://img.shields.io/github/issues/jahid2177/LiveTVCollector)
![GitHub pull requests](https://img.shields.io/github/issues-pr/jahid2177/LiveTVCollector)
...
<a href="https://jahid2177.github.io/iptv" target="_blank"><img src="https://jahid2177.github.io/iptv/img/logo.png" style="width:auto; height:60px" alt="IPTV player"></a>
...
<a href="https://jahid2177.github.io/WebIPTV" target="_blank"><img src="https://jahid2177.github.io/iptv/img/logo.png" style="width:auto; height:60px" alt="Web IPTV"></a>
<a href="https://Mydemoprojecttv.vercel.app" target="_blank"><img src="https://Mydemoprojecttv.vercel.app/img/logo.png" style="width:auto; height:60px" alt="Web IPTV Player"></a>
...
### Prerequisites
- A GitHub account and repository (`jahid2177/LiveTVCollector`).
- No local setup required; everything runs via GitHub Actions.

### Steps
1. **Clone or Fork**:
   ```bash
   git clone https://github.com/jahid2177/LiveTVCollector.git
   cd LiveTVCollector
   ```

2. **Customize Sources** (Optional):
   - Edit `MydemoprojectMain/Country Name.py` to update the `source_urls` list with additional CountryName-specific M3U sources.
...
4. **Automation**:
   - GitHub Actions runs `MydemoprojectMain/Country Name.py` every 8 hours (UTC: 00:00, 08:00, 16:00 ≈ IST: 05:30, 13:30, 21:30).
...
Feel free to:
- Add more Country Name-specific sources to `MydemoprojectMain/CountryName.py`.
...
- Attribution: If you share or use this data, please credit jahid2177/LiveTVCollector.
...
- BTC Lightening: <b>Mydemoproject@speed.app</b>
- SOL: <b>Mydemoproject.sol</b>
