...
class M3UCollector:
    def __init__(self, country="SouthIndian", base_dir="Movies"):
        ...
        for line in lines:
            ...
            if line.startswith('#EXTINF:'):
                ...
                current_channel = {
                    ...
                    'group': group.group(1) if group else "South Indian",
                    'source': source_url
                }
...
def main():
    sources = [
        # India sources — Tamil, Telugu, Malayalam, Kannada
    ...
    collector = M3UCollector(country="SouthIndian")
    ...
    logging.info(f"Done! Total South Indian collected: {total}")
